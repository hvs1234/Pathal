                    ...
                    <div class="maghny-gd-1 col-lg-4 col-md-6 mt-md-0 mt-4">
                        <div class="maghny-grid">
                            <figure class="effect-lily">
                                ...
                                <figcaption>
                                    <div>
                                        <h4 class="top-text"><?php echo htmlspecialchars($room->room_category); ?>
                                            <!-- <ul>
                            ...
                            <div class="room-info">
                                <h3 class="room-title"><a href="#url"><?php echo $hotel_name; ?></a></h3>
                                <ul class="mb-3">
                                ...
                                <div class="room-info-bottom">
                                    ...
                                    <a href="./room" class="btn view">Full Info →</a>
                                </div>
                            </div>
                        </div>
                    </div>
