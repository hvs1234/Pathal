<?php
include"api.php";
 $single_room_api_url = 'https://krishpada.com/software/api/single-rooms.php?domain_name=' . $domain_name.'&room_id='.$_GET['room_id']; 
                    ...
                    <div class="content-photo-1 d-grid">
                        <div class="content-photo-left text-center">
                            ...
                            <div class="border-line">
                                <div class="bg">
                                    <span class="price"><i class='fas fa-map-marker-alt'></i>  Rishikesh</span>
                                   
                                </div>
                                <div class="book-btn px-2">
                                    <a href="<?php echo$booking_url; ?>" class="btn btn-style btn-secondary mt-3"> <i class="fa fa-location"></i> direction map</a>
                                </div>
                            </div>
